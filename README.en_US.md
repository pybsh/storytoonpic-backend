...
> <b>An app that generates stories and images using artificial intelligence</b>
...
### Overview
- Platform: Android
- Technologies Used: Python, FastAPI, Ollama, LLaVA, SDXL, Diffusers
  ...
  <table>
    <tr>
      ...
      <td align="center">
        ...
        <a href="#" title="Frontend Code">💻</a> <a href="#" title="UX/UI Design">🎨</a>
      </td>
      <td align="center">
      ...
      <td align="center">
        ...
        <a href="#" title="Planning">📝</a><a href="#" title="UX/UI Design">🎨</a>
      </td>
    </tr>
  </table>

### Introduction
This app allows users to upload photos and generates storytelling and AI-generated images based on those photos. <br/>
It was created to allow young children to take photos and enjoy fairy-tale-like stories about their pictures.

### Key Features
- Image regeneration in crayon style using SDXL and LoRA
...
- This repository is the **backend server** repository.